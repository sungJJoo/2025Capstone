    ...
    try:
        ...
        with mic as source:
            ...
            while True:
                ...
                command = command.lower().replace(" ", "")  # 대소문자, 공백 제거
        ...
        print(f"🛑 음성 인식 쓰레드 오류: {e}")

def main():
    global mode, last_qr_data
    picam2 = Picamera2()
    ...
    while True:
        ...
        print(f"🟡 현재 모드: {mode}")  # 현재 동작 모드 출력
